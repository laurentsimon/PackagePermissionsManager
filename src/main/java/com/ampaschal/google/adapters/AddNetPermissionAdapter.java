...
public class AddNetPermissionAdapter extends LocalVariablesSorter {

    public AddNetPermissionAdapter(int access, String descriptor, MethodVisitor methodVisitor) {
    ...
    public void visitCode() {
...

        {
            ...
            methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "java/net/URL", "toString", "()Ljava/lang/String;", false);
            methodVisitor.visitInsn(Opcodes.AASTORE);
