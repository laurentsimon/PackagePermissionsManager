...
public class AddFileWritePermissionAdapter extends LocalVariablesSorter {

    String methodDescriptor;

    public AddFileWritePermissionAdapter(int access, String desc, MethodVisitor methodVisitor) {
